...
Basic SQL statements: DDL and DML (no need to read the )
...
File: 16-no_link.sql
 ...
 ALX, All rights reserved.Copyright DonBobGeorgename = Bobname = Alexname = Johnname = doesndemandUse WHEREelseWhatWhatWhatPrivilegeschapter 